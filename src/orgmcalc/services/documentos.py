...
class DocumentosService:
    ...
    @staticmethod
    async def get_documento(document_id: str) -> dict[str, Any] | None:
    ...
    @staticmethod
    async def update_documento(document_id: str, data: dict[str, Any]) -> dict[str, Any] | None:
        """Update document."""
        return await DocumentosRepository.update(document_id, data)

    @staticmethod
    async def delete_documento(document_id: str) -> bool:
        """Delete document."""
        return await DocumentosRepository.delete(document_id)

    @staticmethod
    async def documento_exists(document_id: str) -> bool:
